...
from ui.interactive import GrillableItem, IngredientItem, InteractiveObject
...
class ItemFactory:
    ...
    def create(self, name, pos):
        ...
        if item_type == "grillable":
            ...
            return IngredientItem(name, pos, loaded_surfaces.get("default", next(iter(loaded_surfaces.values()))))
        else:
